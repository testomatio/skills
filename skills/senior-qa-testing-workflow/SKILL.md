---
name: senior-qa-testing-workflow
...
| Skill                   | Purpose                                             |
| ----------------------- | --------------------------------------------------- |
| **qa-write-test-cases** | Generate new test cases from requirements           |
...
3. 🎭 Generate specific test cases using `qa-write-test-cases` skill and role name (e.g. "pessimist")
```
