...
![Explorbot testing flows](workflow.png)
...
| `./experience/` | Explorbot | Auto-saved working locators/flows (FLOW/ACTION blocks + `related:` URLs). Inspect via `explorbot experience` |
